...
# Modify the CSS to adjust logo size and remove color inversion
echo "Modifying CSS to display the logo correctly..."

# Add the following custom CSS for the logo at the end of ext6-pve.css
sudo bash -c "cat >> $LOGO_CSS_PATH << 'EOF'
